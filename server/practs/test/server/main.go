...
func main() {
	...
	pb.RegisterMoneyTransactionServer(s, &serv{})
...
*/
func (s *serv) MakeTransaction(ctx context.Context, in *pb.TransactionRequest) (*pb.TransactionResponse, error) {
